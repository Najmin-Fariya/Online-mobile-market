...
if (isset($_POST['submit'])) {
   ...
   $sql = mysqli_query($con,"UPDATE login SET name='$_POST[name]' ,  password='$password' ,  phone='$_POST[phone]',real_pass='$_POST[password]', img='$i'  WHERE email='$email' ");//save to DB with new image name
...
else // no image uploaded
{
   ...
   $sql = mysqli_query($con,"UPDATE login SET name='$_POST[name]' ,  password='$password' ,  phone='$_POST[phone]',  real_pass='$_POST[password]'   WHERE email='$email' ");//save to DB but no change image column
