...
if (isset($_POST['submit'])) {
   ...
   $sql = mysqli_query($con,"UPDATE vendor SET name='$_POST[name]' ,  password='$password' , email='$_POST[email]', phone='$_POST[phone]',real_pass='$_POST[password]', img='$i'  WHERE id='$id' ");//save to DB with new image name
...
else // no image uploaded
{
   ...
   $sql = mysqli_query($con,"UPDATE vendor SET name='$_POST[name]' ,  password='$password' , email='$_POST[email]', phone='$_POST[phone]',real_pass='$_POST[password]'  WHERE id='$id' ");//save to DB but no change image column
...
<?php
 include '../db_connect.php';                
     @$id= $_GET['id'];
     $result = mysqli_query($con,"SELECT * FROM vendor  WHERE id='$id' ");
...
?>
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" class="btn btn-default btn-success" value="Update Vendor">
                        </div>
                    </form>
