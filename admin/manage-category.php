                  ...
                  <div class="panel panel-default">
                        ...
                        <h3 style="color: red; text-align: center;">
                             <?php
                              ...
                              if (isset($_GET['id']))  {
                                   $sql = mysqli_query($con,"DELETE FROM   categories  WHERE id='$id' ");
                    ...
                    {echo '<tr class="odd gradeX">
                            ...
                            <a href="edit-category.php?id='.$row['category_id'].'" class="btn btn-primary btn-xs" title="Edit">
                                <span class="glyphicon glyphicon-edit"></span>
                            </a>
                            <a href="?id='.$row['category_id'].'" class="btn btn-danger btn-xs" title="Delete" id="delete" >
