...
if (isset($_GET['unpublished'])) {   
 mysqli_query($con, "UPDATE product SET approve='Non Approve' WHERE id='$id' ");
        echo  '<span style="color:red">This Product Non Approved</span>';
...
if (isset($_GET['published'])) {   
 mysqli_query($con, "UPDATE product SET approve='Approve' WHERE id='$id' ");
echo '<span style="color:green">This Product  Approve now</span>';
...
if (isset($_GET['special'])) {   
 mysqli_query($con, "UPDATE product SET special='Special' WHERE id='$id' ");
    ...
    <?php
        ...
        $i = 1;
        $result = mysqli_query($con,"SELECT * FROM product WHERE approve='Non Approve' ORDER BY id DESC ");
 ...
 {echo '<tr>
    ...
    <td style="width:110px">
        ...
        <a href="?published=published&id='.$row['id'].'" class="btn btn-success btn-xs" title="Approve" id="approve">
