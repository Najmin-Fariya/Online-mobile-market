...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Non Approve Vendor  List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
if (isset($_GET['published'])) {   
 mysqli_query($con, "UPDATE vendor SET approve='Approve' WHERE id='$id' ");
echo '<span style="color:green">Vendor Approve now</span>';
    ...
    <?php
        ...
        $i = 1;
        $result = mysqli_query($con,"SELECT * FROM vendor WHERE approve='Non Approve' ORDER BY id DESC ");
 ...
 content: counter(serial-number); 
   ...
   <?php include 'includes/script.php' ?>
    ...
    $("#approve").click(function(){
        return confirm("are you sure Approve this Vendor?");
    });
