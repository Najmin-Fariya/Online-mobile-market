...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Seen Comment </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
if (isset($_GET['seen'])) {   
 mysqli_query($con, "UPDATE contact SET seen='Unseen' WHERE id='$id' ");
    ...
    <?php
                    ...
                    $result = mysqli_query($con, "SELECT * FROM  contact WHERE seen='seen' ORDER BY id DESC");
...
.css-serial td:first-child:before {
 ...
 content: counter(serial-number); 
   ...
   <?php include 'includes/script.php' ?>
    ...
    $("#seen").click(function(){
        return confirm("Do you change  Unseen  this Comment?");
    });
