...
<?php
            ...
            $page_q= "SELECT count(*) \"total\" FROM  product WHERE brand='$brand'";
            ...
            $res=mysqli_query($con,"SELECT * FROM product WHERE brand='$brand' AND approve='Approve' ORDER BY id DESC LIMIT $k,$item");
