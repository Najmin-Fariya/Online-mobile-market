            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="text-align: center;">Vendor Sign In</h3>
                    </div>
                    <div class="panel-body">
                        <form  action="login.php" method="post">
                            ...
                            <h5 style="color: green;font-weight: bold;font-size: 13.5px;text-align: center;padding-top: 20px;">If you have don't account Please <a href="signup.php">Sign up</a> at first</h5>
                        </form>
